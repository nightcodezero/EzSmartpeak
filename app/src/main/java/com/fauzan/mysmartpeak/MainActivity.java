    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                printValues.put(EzSmartpeak.PrintText("MobilityOne Sdn Bhd", 2, EzSmartpeak.TEXT_CENTER, EzSmartpeak.TEXT_BOLD));
                ...
                printValues.put(EzSmartpeak.EmptySpace());
                printValues.put(EzSmartpeak.PrintText("BOOST PAYMENT", 2, EzSmartpeak.TEXT_CENTER, EzSmartpeak.TEXT_BOLD));
                printValues.put(EzSmartpeak.EmptySpace());
                ...
                printValues.put(EzSmartpeak.LineSplit());
                printValues.put(EzSmartpeak.PrintDimensionObject(EzSmartpeak.DIMENSION_TWO, "HELLO", 3, EzSmartpeak.TEXT_CENTER, 1));
