    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                printValues.put(EzSmartpeak.PrintText("TXN ID: " + "1000000002960639", 2, EzSmartpeak.TEXT_LEFT));
                printValues.put(EzSmartpeak.PrintText("MERCHANT: " + "ONEPAY TPM", 2, EzSmartpeak.TEXT_LEFT));
                ...
                printValues.put(EzSmartpeak.LineSplit());
                printValues.put(EzSmartpeak.PrintDimensionObject(EzSmartpeak.DIMENSION_TWO, "1000000002960639", 3, EzSmartpeak.TEXT_CENTER, 1)); // print qrcode
